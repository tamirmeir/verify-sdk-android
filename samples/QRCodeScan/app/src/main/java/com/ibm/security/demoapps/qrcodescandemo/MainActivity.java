...
public class MainActivity extends AppCompatActivity {
    ...
    private void Test() {
        ...
        try {
            ...
            KeyStoreHelper.createKeyPair("myKeyName", "SHA256withRSA", false, new IResultCallback<PublicKey>() {
                @Override
                public void handleResult(PublicKey publicKey, VerifySdkException e) {

                }
            });

            OnPremiseAuthenticator onPremiseAuthenticator = new OnPremiseAuthenticator("your QR code scan result here");
            ...
            for(AuthenticationMethod authenticationMethod : onPremiseAuthenticator.getAvailableMethods())    {
                ...
                signatureAuthenticationMethod.setPublicKey(KeyStoreHelper.exportPublicKey("myKeyName", Base64.NO_WRAP));

            }

            AuthenticatorContext.sharedInstance().enroll();
